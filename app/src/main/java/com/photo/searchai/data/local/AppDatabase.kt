...
/**
 * Room database for the photo search system. Stores images, OCR text, barcodes, image labels, and
 * worker history.
 */
@Database(
        entities =
...
abstract class AppDatabase : RoomDatabase() {
    ...
    companion object {
        ...
        /**
         * Migration from version 1 to 2. Adds barcodeParsed, labelParsed columns to images table.

...
@Singleton
class MediaStoreIndexerImpl @Inject constructor(@ApplicationContext private val context: Context) :
        MediaStoreIndexer {
    ...
    private val projection =
            arrayOf(
                    ...
                    else MediaStore.Images.Media._ID, // Fallback for favorite
            )
                ...
                contentResolver.query(
                        ...
                        ?.use { cursor ->
                            ...
                            while (cursor.moveToNext()) {
                                ...
                                val isFavorite =
                                        if (favCol != -1) cursor.getInt(favCol) == 1 else false
                                ...
                                mediaItems.add(
                                        MediaItem(
                                                ...
                                                isHidden =
                                                        path.contains("/.") // Simple hidden check
                                        )
                                )
                            }
                        }
